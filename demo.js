...
function content(){
    ...
    var div = bubble.create("test test test test test test test test test test test test test test test test test test", 120, 120, 500, 400, {/*tailBaseAngle: 90, */tailWidth: 30});
